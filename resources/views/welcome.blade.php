            ...
            <div class="container">
                <div class="hero-inner">
                    <div class="hero-copy">
                        ...
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">{{ $header->title }}</h1>
                        <p class="hero-paragraph is-revealing">{{ $header->description }}</p>
                        @endforeach
                        <p class="hero-cta is-revealing"><a class="button button-primary button-shadow scroll" href="#pricing">Pricing and plans</a></p>
                    </div>
                            ...
                            <div class="pricing-table-inner">
                                <div class="pricing-table-main">
                                    <div class="pricing-table-header is-revealing">
                                        <div class="pricing-table-title mt-12 mb-8">{{ $price->title }}</div>
                                        <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2">{{ $price->price }}</span>/mo</div>
                                    </div>
                                    <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                        @foreach($price->conditions as $priceFeature)
                                            ...
                                            <span>{{ $priceFeature->feature }} </span>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
    ...
    <footer class="site-footer text-light">
        <div class="container">
            <div class="site-footer-inner has-top-divider">
                ...
                <div class="footer-copyright">&copy; {{ now()->year }} MI SHAJIB. All rights reserved</div>
            </div>
        </div>
    </footer>
</div>
